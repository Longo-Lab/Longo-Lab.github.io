---
layout: annot
title: snRNAseq annotation (v1.0)
parent: Tutorials
nav_order: 4
---
...
> Archived version
>
> This page describes our earlier framework, built on the Yao 2021 cortex & hippocampus reference with a `class → neighborhood → subclass` taxonomy. It is kept for reference. Current practice uses the Allen Institute whole mouse brain atlas and MapMyCells — see [snRNAseq annotation](/docs/tutorials/snRNAseq_annotation.html).
