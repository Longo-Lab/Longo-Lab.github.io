...
<section class="page-section" id="software">
    <div class="container">
        ...
        <div class="row text-center justify-content-center">
            ...
            <div class="col-md-4">
                <img src="/assets/images/longo_github_icon.png" alt="Longo Lab GitHub" style="height: 100px;" class="mb-3" />
                <h4 class="my-3"><a href="https://github.com/Longo-Lab">Longo Lab GitHub</a></h4>
                <p class="text-muted">Source code, analysis pipelines, and tools from the Longo Lab.</p>
            </div>
        </div>
    </div>
</section>
